...
pub fn build_zlib_ng(target: &str, compat: bool) {
    ...
    if target.starts_with("arm") && !target.starts_with("aarch64") {
        // Zig's ARM NEON headers define helper macros that collide with zlib-ng's
        // compatibility declarations. Use zlib-ng's portable ARM implementation.
        cmake
            .define("WITH_ARMV6", "OFF")
